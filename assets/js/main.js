const defaultContentData = {
    ...
    carousel: [
      {
        ...
        items: ["High Quality Design", "Mobile Friendly", "Secure & Easy Shopping"]
      },
      {
        img: "./assets/images/education.jpg",
        alt: "Educational website development - learning management system",
        title: "Educational Websites",
        items: ["Highly Professional", "Mobile Friendly", "Easy Course Management"]
      },
      {
        img: "./assets/images/Business.jpg",
        alt: "Professional business website development services",
        title: "Business Websites",
        items: ["User-Friendly Interface", "Mobile Friendly", "Fast & SEO Optimized"]
      },
      {
        img: "./assets/images/data_entry.jpg",
        alt: "Accurate data entry and processing services",
        title: "Data Entry",
        items: ["Accurate & High-Quality Work", "Fast & Efficient Processing", "Secure Data Handling"]
      }
    ]
  },
  about: {
  ...
  whyUs: {
    ...
    subtitle: "Delivering excellence through quality, innovation, and dedication",
    stats: [
  ...
  portfolio: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Modern website for the school with student information and updates",
        delay: 200
      }
    ]
  },
  ...
  contact: {
    header: {
      title: "Get in Touch",
      subtitle: "Have a project idea? We'd love to hear from you. Reach us through the options below."
    },
    cards: [
      {
    ...
    locationCard: {
      ...
      iframeSrc: "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3586.38780373091!2d84.1769507!3d25.9881109!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39925d000798f3c1%3A0x88a2cfa3d74437f5!2sHasvik%20technologies!5e0!3m2!1sen!2sin!4v1778164854135!5m2!1sen!2sin",
      mapAlt: "Google Maps location of HASVIK Technologies office in Maniar, Ballia, Uttar Pradesh"
    }
  }
};
...
function renderHero(hero) {
  ...
  heroContent.appendChild(createElement('span', { class: 'typed', id: 'typed-hero', style: 'min-height:24px' }, []));

  const buttonRow = createElement('div', { class: 'mt-4' });
  hero.buttons.forEach((button) => {
    buttonRow.appendChild(createElement('a', {
      href: button.href,
...
function renderAbout(about) {
  ...
  const row = createElement('div', { class: 'row g-4' }, [
    ...
    createElement('div', { class: 'col-md-6 col-lg-12 text-center mt-4', 'data-aos': 'fade-up' }, [
      createElement('ul', { class: 'list-unstyled row' }, about.highlights.map((highlight) =>
...
function renderServices(services) {
  ...
  container.appendChild(createElement('h2', { class: 'text-center', 'data-aos': 'fade-up' }, [services.heading]));
  container.appendChild(createElement('p', { class: 'mb-5 text-center services-subtitle' }, [services.subtitle]));

  const row = createElement('div', { class: 'row g-4' }, services.items.map((item, index) =>
    createElement('div', { class: 'col-lg-4 col-md-6', 'data-aos': 'fade-up', 'data-aos-delay': `${120 + index * 60}` }, [
      createElement('div', { class: 'card service-card h-100 p-4' }, [
        createElement('div', { class: 'd-flex align-items-start gap-3' }, [
          createElement('div', { class: 'service-icon' }, [createElement('i', { class: item.icon })]),
          createElement('div', {}, [
            createElement('h6', {}, [item.title]),
...
function renderWhyUs(whyUs) {
  ...
  container.appendChild(createElement('div', { class: 'text-center mb-5' }, [
    createElement('h2', { class: 'fw-bold text-white display-5 mb-3' }, [whyUs.heading]),
    createElement('p', { class: 'text-light opacity-75 mx-auto', style: 'max-width: 600px;' }, [whyUs.subtitle])
  ]));

  const statsRow = createElement('div', { class: 'row text-center mb-5' }, whyUs.stats.map((stat) =>
    createElement('div', { class: 'col-md-4' }, [
      createElement('div', { class: 'counter', 'data-target': stat.target }, ['0']),
      createElement('p', { class: 'text-light small' }, [stat.label])
    ])
  ));
  container.appendChild(statsRow);

  const cardsRow = createElement('div', { class: 'row g-4' }, whyUs.cards.map((card) =>
    createElement('div', { class: 'col-xl-3 col-md-6' }, [
      createElement('div', { class: 'why-card h-100 text-center p-4' }, [
        createElement('div', { class: 'icon-box mb-4' }, [createElement('i', { class: card.icon })]),
        createElement('h5', { class: 'text-white fw-semibold mb-3' }, [card.title]),
        createElement('p', { class: 'text-light opacity-75 small mb-0' }, [card.text])
      ])
    ])
  ));
...
function renderPortfolio(portfolio) {
  ...
  container.appendChild(createElement('div', { class: 'text-center mb-5', 'data-aos': 'fade-up' }, [
  ...
  const row = createElement('div', { class: 'row justify-content-center g-4' }, portfolio.items.map((item) =>
    createElement('a', {
      target: '_blank',
      rel: 'noopener',
      href: item.href,
      ...
      createElement('div', { class: 'work-video-card' }, [
        item.badge ? createElement('span', { class: 'premium-badge' }, [item.badge]) : null,
        createElement('img', {
          class: 'h-100 w-auto',
          src: item.img,
          alt: item.alt
...
function renderTestimonials(testimonials) {
  ...
  const row = createElement('div', { class: 'row g-4' }, testimonials.items.map((item) =>
    createElement('div', {
      class: 'col-md-4',
      'data-aos': 'fade-up',
      'data-aos-delay': item.delay
...
function renderContact(contact) {
  ...
  const header = createElement('div', { class: 'contact-header text-center text-white' }, [
  ...
  const cardRow = createElement('div', { class: 'row justify-content-center g-4' }, [
    ...contact.cards.map((card) => createElement('div', { class: 'col-md-5', 'data-aos': 'fade-up' }, [
    ...
    createElement('div', { class: 'col-md-10', 'data-aos': 'fade-up', 'data-aos-delay': 100 }, [
      createElement('div', { class: 'contact-box text-center' }, [
